...
Das System nutzt eine faire "Double Chance" Mechanik:
    ...
    Verliert ein Fahrer im Hauptrennen (Gold) direkt in Runde 0 (der ersten Runde), scheidet er nicht aus.

    Er wird automatisch in das untere Redemption Bracket (Rot) verschoben.

    Dort kämpft er um den Titel des "Redemption King" (Platz 3 der Gesamtwertung).
...
In der Sidebar befindet sich der Wildcard Pool.
    ...
    Dort werden alle Fahrer gelistet, die sich im Redemption-Bracket befinden (oder manuell hinzugefügt wurden).
